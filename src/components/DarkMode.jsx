...
function DarkMode() {
  ...
  return (
    <div className='w-28 flex flex-row justify-start gap-12 bg-slate-200 py-2 px-2 rounded-full shadow-2xl border border-black dark:bg-slate-50' id='CambiarLado'>
